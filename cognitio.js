...
createApp({
  data() {
    return {
      ...
      clients: ['Melo & Cia Advogados', 'CRO-MG', 'OdontoClin', 'Pref. Pará de Minas', 'PetVida'],
      stats: [{ value: '5', label: 'Sistemas ativos' }, { value: '200+', label: 'Clientes atendidos' }, { value: '98%', label: 'Satisfação' }, { value: '7', label: 'Anos de mercado' }],
      aboutStats: [{ value: '200+', label: 'Clientes ativos' }, { value: '5', label: 'Produtos' }, { value: '40+', label: 'Colaboradores' }, { value: '7', label: 'Anos de exp.' }, { value: '3', label: 'Estados' }],
      products: [
        { id: 1, name: 'Ordo', shortDesc: 'Advocacia e processos jurídicos.', iconClass: 'fas fa-book-open text-blue-700', bgClass: 'bg-blue-50 border border-blue-200' },
      ...
      testimonials: [
        { name: 'Dra. Mariana Fonseca', role: 'Advogada — BH/MG', initials: 'MF', color: 'linear-gradient(135deg,#1a4fa0,#0d1f3c)', quote: 'O Ordo transformou completamente nossa gestão. Controlamos todos os processos e prazos em um único lugar, sem planilhas.' },
        { name: 'Paulo Ribeiro', role: 'Gestor — CRF-MG', initials: 'PR', color: 'linear-gradient(135deg,#4338ca,#1e1b4b)', quote: 'O Synapses nos trouxe transparência e agilidade que antes não tínhamos. O suporte da Cognitio é excepcional.' },
        { name: 'Dr. Leandro Castro', role: 'Dentista — Clínica Sorrir', initials: 'LC', color: 'linear-gradient(135deg,#0891b2,#155e75)', quote: 'O Oralis é intuitivo e completo. Minha recepcionista aprendeu em menos de um dia. Os pacientes amam o agendamento online.' },
        { name: 'Fernanda Góes', role: 'Diretora — Pet Feliz', initials: 'FG', color: 'linear-gradient(135deg,#d97706,#92400e)', quote: 'O Petys unificou agendamento, estoque, caixa e prontuário. Antes eram 3 sistemas. Agora é um só, muito mais simples.' },
      ],
      productsDetail: [
        { id: 1, name: 'Ordo', sector: 'Escritórios de Advocacia', headline: 'Organização total para o escritório jurídico moderno', description: 'O Ordo centraliza processos, prazos, clientes, honorários e documentos em uma plataforma feita sob medida para advogados. Reduza erros, elimine planilhas e entregue mais valor ao seu cliente.', feats: ['Gestão completa de processos e prazos', 'Controle financeiro e honorários', 'Agenda e compromissos integrados', 'Portal do cliente seguro', 'Relatórios de produtividade', 'Controle de documentos e petições', 'Notificações automáticas de prazo'], iconClass: 'fas fa-book-open', iconBg: 'linear-gradient(135deg,#dbeafe,#bfdbfe)', color: '#1a4fa0', light: '#eff6ff', border: '#bfdbfe', shadow: 'rgba(26,79,160,.18)', tagBg: '#dbeafe', tags: ['Processos', 'Financeiro', 'Agenda', 'Documentos'] },
      ...
      timeline: [
        { year: '18', title: 'Fundação da Cognitio', tag: 'Origem', tagBg: '#eff6ff', tagColor: '#1a4fa0', desc: 'A empresa nasce em Belo Horizonte com a missão de criar tecnologia especializada para setores carentes de boas ferramentas digitais.' },
        { year: '19', title: 'Lançamento do Ordo', tag: '1º Produto', tagBg: '#dbeafe', tagColor: '#1a4fa0', desc: 'Nosso primeiro sistema, para escritórios de advocacia, conquista seus primeiros 30 clientes em Minas Gerais.' },
        { year: '21', title: 'Expansão do portfólio', tag: 'Crescimento', tagBg: '#e0e7ff', tagColor: '#4338ca', desc: 'Lançamento simultâneo do Synapses e Oralis, ampliando nossa atuação para conselhos profissionais e odontologia.' },
        { year: '23', title: 'Setor público e pet shops', tag: 'Inovação', tagBg: '#e0f2fe', tagColor: '#0284c7', desc: 'Licitus e Petys entram em produção, completando o ecossistema com 5 produtos verticais distintos.' },
        { year: '25', title: 'Série A e expansão', tag: 'Escala', tagBg: '#f0fdf4', tagColor: '#16a34a', desc: 'Captação de investimento, crescimento da equipe para 40+ pessoas e início do atendimento em SP e RJ.' },
        { year: '26', title: 'Presente: 200+ clientes', tag: 'Hoje', tagBg: '#fef3c7', tagColor: '#d97706', desc: 'Com mais de 200 clientes ativos e NPS acima de 70, iniciamos o planejamento de internacionalização para América Latina.' },
      ],
      team: [
        { name: 'Carlos Melo', initials: 'CM', role: 'CEO & Co-fundador', color: 'linear-gradient(135deg,#1a4fa0,#0d1f3c)', bio: '15 anos em tecnologia e produtos digitais. Ex-TOTVS e Stefanini.' },
        { name: 'Fernanda Lima', initials: 'FL', role: 'CTO', color: 'linear-gradient(135deg,#0891b2,#155e75)', bio: 'Arquiteta de software e cloud. AWS Certified Solutions Architect.' },
        { name: 'Rafael Costa', initials: 'RC', role: 'Head de Produto', color: 'linear-gradient(135deg,#4338ca,#1e1b4b)', bio: 'Focado em UX e estratégia de produto. Ex-Resultados Digitais.' },
        { name: 'Juliana Santos', initials: 'JS', role: 'Head Comercial', color: 'linear-gradient(135deg,#d97706,#92400e)', bio: 'Especialista em vendas B2B. Mais de 100 clientes conquistados.' },
        { name: 'André Pereira', initials: 'AP', role: 'Head de CS', color: 'linear-gradient(135deg,#16a34a,#14532d)', bio: 'Garante NPS acima de 70 e onboarding de excelência para cada cliente.' },
        { name: 'Beatriz Nunes', initials: 'BN', role: 'Head de Design', color: 'linear-gradient(135deg,#db2777,#831843)', bio: 'Designer de produto com foco em acessibilidade e experiências memoráveis.' },
      ],
      valuesDetail: [
      ...
      contactInfo: [
        { icon: 'fas fa-map-marker-alt', label: 'Endereço', value: 'Av. do Contorno, 6594 — 8º andar', sub: 'Savassi, Belo Horizonte — MG' },
        { icon: 'fas fa-envelope', label: 'E-mail', value: 'contato@cognitio.com.br', sub: 'comercial@cognitio.com.br (vendas)' },
        { icon: 'fas fa-phone', label: 'Telefone', value: '(31) 3000-0000', sub: 'Seg a Sex, 8h às 18h' },
        { icon: 'fab fa-whatsapp', label: 'WhatsApp', value: '(31) 99000-0000', sub: 'Atendimento prioritário' },
      ],
    }
  },
  mounted() {
